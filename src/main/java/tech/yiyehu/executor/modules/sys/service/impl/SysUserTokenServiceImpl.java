...
import tech.yiyehu.executor.modules.sys.oauth2.TokenGenerator;
...
public class SysUserTokenServiceImpl extends ServiceImpl<SysUserTokenDao, SysUserTokenEntity> implements SysUserTokenService {
	...
	@Override
	public ResultUtil createToken(long userId) {
		//生成一个token
		...
		ResultUtil resultUtil = ResultUtil.ok().put("token", token).put("expire", EXPIRE);
